...
from fun_with_ast.composite_placeholder_source_match import CompositePlaceholder, ListFieldPlaceholder
...
#     else:
#         field.matcher = dynamic_matcher.GetDynamicMatcher(field, starting_parens)
#         if text:
